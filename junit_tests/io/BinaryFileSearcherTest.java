...
public class BinaryFileSearcherTest {
	...
	public void partialSearchingTest() {
		...
		try {
			final RandomAccessFile r = new RandomAccessFile(WAYS, "r");
	...
	public void pagingTest() {
		try {
			...
			final List<String> result = (BinaryFileSearcher.getPage(WAYS, "/w/4170.7125", "/w/4170.7126", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			...
			final List<String> result2 = (BinaryFileSearcher.getPage(WAYS, "/w/4170.7125", "/w/4170.7127", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			...
			// Top of the file
			final List<String> result3 = (BinaryFileSearcher.getPage(WAYS, "/w/4015.7374", "/w/4015.7375", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			...
			final List<String> result4 = (BinaryFileSearcher.getPage(WAYS, "/w/4208.7180", "/w/4208.7181", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			...
			// Bottom of file
			final List<String> result5 = (BinaryFileSearcher.getPage(WAYS, "/w/4209.7169", "/w/4209.7169", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			...
			// Problematic Chunks
			final List<String> result6 = (BinaryFileSearcher.getPage(WAYS, "/w/4176.7135", "/w/4176.7136", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			assertTrue(result6 != null);
			assertTrue(result6.get(0).contains("/w/4176.7135"));
			System.out.println("size of result was: " + result6.size());
			
			final List<String> result7 = (BinaryFileSearcher.getPage(WAYS, "/w/4175", "/w/4176", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
			assertTrue(result7 != null);
			// assertTrue(result7.get(0).contains("/w/4175"));
			System.out.println("size of result was: " + result7.size());
			
			final List<String> result8 = (BinaryFileSearcher.getPage(WAYS, "/w/4180.7147", "/w/4180.7146", IOController
					.getWaysHeaderMap().get("id"), "\\t"));
