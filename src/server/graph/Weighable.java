...
/**
 * Classes implementing this interface can be used as "content" within GraphEdges
 * in this package's graph implementation
...
public interface Weighable<T> {
	...
	/**
	 * Weighable objects can decide how they want to be weighed,
	 * This weight is used as the weights of the edges in the graph implementation
